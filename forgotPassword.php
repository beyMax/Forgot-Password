...
if(isset($_POST["q"])){
	...
	$query="SELECT id, password, firstname, lastname FROM professionals WHERE email='$email'";
...
<br>If you can\'t open the link, you can copy and paste the following link in your web browser:<br />
		https://cxlist.com/resetPassword.php?q='.$encrypt.'&id='.$id.'
...
<td width="128" align="right">© 2016 <span class="il">CXLIST.COM</span></td>
	...
	echo '<script type="text/javascript">window.location="https://cxlist.com/prologin.php";</script>';
}
...
function test_input($data) {
	...
	echo '<script type="text/javascript">window.location="https://cxlist.com";</script>';
?>